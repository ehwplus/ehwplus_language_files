...
class EhwplusAppLocalizationsEn extends EhwplusAppLocalizations {
  ...
  String consumptionYearly(String ofRange, String consumption) {
    return 'Your electricity consumption $ofRange is $consumption kWh for the year.';
  }
  ...
  @override
  String get consumptionYearlyDetailedLevel2 => 'within a normal range';

  @override
  String get consumptionYearlyDetailedLevel3 => 'relatively high';

  @override
  String get consumptionYearlyDetailedLevel4 => 'within a normal range';

  @override
  String consumptionYearlyDetailedYouConsume(String verbSuffix) {
    return 'You consume$verbSuffix ';
  }
  ...
  String consumptionYearlyDetailedComparisonEqual(
    ...
    return 'You consume$verbSuffix about the same as an average household with $householdSize $personLabel.';
  }
  ...
  @override
  String get consumptionYearlyDetailedOptimalEnding => 'How are you doing it?';

  @override
  String consumptionYearlyDetailedLevel1Suffix(String nextToOptimal) {
    return 'You would reach optimal consumption with about $nextToOptimal kWh/month less.';
  }

  @override
  String consumptionYearlyDetailedLevel2Suffix(String nextToOptimal) {
    return 'Reducing around $nextToOptimal kWh/month would bring you to a good consumption level.';
  }
  ...
  @override
  String get consumptionWaterPrefixSingle => 'You consume ';

  @override
  String get consumptionWaterPrefixPerPerson =>
      'Per person, everyone consumes ';
  ...
  String consumptionWaterDailyMonthly(
    ...
    return 'about $dailyLiters liters per day (≈ $monthlyCubicMeters $unitName per month).';
  }
  ...
  String consumptionWaterOverallEqual(
    ...
    return 'Your water consumption $ofRange matches that of an average household with $householdSize $personLabel.';
  }
  ...
  String consumptionWaterColdLess(String percentage) {
    return 'Cold water: $percentage less than the average household.';
  }

  @override
  String consumptionWaterColdMore(String percentage) {
    return 'Cold water: $percentage more than the average household.';
  }

  @override
  String get consumptionWaterColdEqual =>
      'Cold water: about the same as the average household.';

  @override
  String consumptionWaterWarmLess(String percentage) {
    return 'Hot water: $percentage less than the average household.';
  }

  @override
  String consumptionWaterWarmMore(String percentage) {
    return 'Hot water: $percentage more than the average household.';
  }

  @override
  String get consumptionWaterWarmEqual =>
      'Hot water: about the same as the average household.';
  ...
  String commonUserLoginDescriptionLoggedInSavedPurchases(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'You are using the EHW+ account. $count purchased products have been saved on the EHW+ server.',
      one:
          'You are using the EHW+ account. $count purchased product has been saved on the EHW+ server.',
      zero:
  ...
  String importErrorCsvIgnoredColumns(int columns) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Only the first two columns were used, $columns columns were ignored.',
      one:
          'Only the first two columns were used. The third column was ignored.',
    );
    return '$_temp0';
  }
  ...
  String get waterExtractionMinimumLevelLower =>
      'Deduction takes place because consumption is lower than threshold.';
  ...
  @override
  String get settingObjectLocation => 'Location';
  ...
  String priceComparisonDiff(
    ...
    return 'You pay $diffWithCurrency $_temp0 the average in $countryName.';
  }

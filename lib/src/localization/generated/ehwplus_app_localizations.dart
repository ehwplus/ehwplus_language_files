...
abstract class EhwplusAppLocalizations {
  ...
  /// No description provided for @consumptionWaterPrefixSingle.
  ///
  /// In en, this message translates to:
  /// **'You consume '**
  String get consumptionWaterPrefixSingle;

  /// No description provided for @consumptionWaterPrefixPerPerson.
  ///
  /// In en, this message translates to:
  /// **'Per person, everyone consumes '**
  String get consumptionWaterPrefixPerPerson;

  /// No description provided for @consumptionWaterDailyMonthly.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Your water consumption {ofRange} matches that of an average household with {householdSize} {personLabel}.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Cold water: {percentage} less than the average household.'**
  String consumptionWaterColdLess(String percentage);

  /// No description provided for @consumptionWaterColdMore.
  ///
  /// In en, this message translates to:
  /// **'Cold water: {percentage} more than the average household.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Hot water: {percentage} less than the average household.'**
  String consumptionWaterWarmLess(String percentage);

  /// No description provided for @consumptionWaterWarmMore.
  ///
  /// In en, this message translates to:
  /// **'Hot water: {percentage} more than the average household.'**

...
import 'ehwplus_app_localizations_id.dart';
...
abstract class EhwplusAppLocalizations {
  ...
  /// No description provided for @watersupplierAccessRequestApprovedPendingOnboarding.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @watersupplierAccessRequestPostponed.
  ///
  /// In en, this message translates to:
  /// **'Your access request is still being checked. Please be patient.'**
...
EhwplusAppLocalizations lookupEhwplusAppLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    ...
    case 'id':
      return EhwplusAppLocalizationsId();
    case 'it':

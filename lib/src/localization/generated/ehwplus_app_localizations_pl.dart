...
class EhwplusAppLocalizationsPl extends EhwplusAppLocalizations {
  ...
  String ofRangeLastMonths(int months) {
    return 'za ostatnie miesiące $months';
  }
  ...
  @override
  String get consumptionYearlyDetailedLevel1 => 'naprawdę na co popatrzeć';

  @override
  String get consumptionYearlyDetailedLevel2 => 'normalne.';

  @override
  String get consumptionYearlyDetailedLevel3 => 'stosunkowo wysoki';

  @override
  String get consumptionYearlyDetailedLevel4 => 'normalne';

  @override
  String consumptionYearlyDetailedYouConsume(String verbSuffix) {
    return 'Zużywasz$verbSuffix';
  }
  ...
  String consumptionYearlyDetailedComparisonLess(
    ...
    return 'Zużywasz$verbSuffix $percentage mniej niż przeciętne gospodarstwo domowe z $householdSize $personLabel.';
  }
  ...
  String consumptionYearlyDetailedComparisonMore(
    ...
    return 'Zużywasz$verbSuffix $percentage więcej niż przeciętne gospodarstwo domowe z $householdSize $personLabel.';
  }
  ...
  String consumptionYearlyDetailedComparisonEqual(
    ...
    return 'Zużywasz$verbSuffix mniej więcej tak samo jak przeciętne gospodarstwo domowe z $householdSize $personLabel.';
  }
  ...
  @override
  String get consumptionYearlyDetailedOptimalEnding => 'Jak to robisz?';

  @override
  String consumptionYearlyDetailedLevel1Suffix(String nextToOptimal) {
    return 'Brakuje $nextToOptimal kWh/miesiąc do optymalnego zużycia.';
  }

  @override
  String consumptionYearlyDetailedLevel2Suffix(String nextToOptimal) {
    return 'Brak $nextToOptimal kWh/miesiąc ze względu na dobre zużycie.';
  }
  ...
  @override
  String get consumptionWaterPrefixSingle => 'Konsumujesz';

  @override
  String get consumptionWaterPrefixPerPerson => 'Na osobę konsumuje każdy';
  ...
  String consumptionWaterDailyMonthly(
    ...
    return 'około $dailyLiters litrów dziennie (≈ $monthlyCubicMeters $unitName na miesiąc).';
  }
  ...
  String consumptionWaterDailyMonthlySingle(
    ...
    return 'Konsumujesz około $dailyLiters litrów dziennie (≈ $monthlyCubicMeters $unitName na miesiąc).';
  }
  ...
  String consumptionWaterDailyMonthlyPerPerson(
    ...
    return 'Na osobę konsumuje każdy około $dailyLiters litrów dziennie (≈ $monthlyCubicMeters $unitName na miesiąc).';
  }
  ...
  String consumptionWaterOverallLess(
    ...
    return 'Twoje zużycie wody $ofRange jest $percentage niższe niż w przeciętnym gospodarstwie domowym korzystającym z $householdSize $personLabel.';
  }
  ...
  String consumptionWaterOverallMore(
    ...
    return 'Twoje zużycie wody $ofRange jest $percentage wyższe niż w przeciętnym gospodarstwie domowym wyposażonym w $householdSize $personLabel.';
  }
  ...
  String get smartMeterErrorNoData =>
      'Niestety nie ma żadnych danych, które aplikacja mogłaby wyświetlić.';
  ...
  String get consumptionCacheManagementConfirmClearCacheAndSyncTitle =>
      'Wyczyścić pamięć podręczną i zsynchronizować?';
  ...
  String get tibberMessageAccessTokenUpdated =>
      'Pomyślnie zaktualizowano token dostępu';

  @override
  String get tibberErrorAccessTokenInvalid =>
      'Wygląda na to, że token dostępu jest nieprawidłowy';
  ...
  String get tibberConsentScreenConfigureNowButton =>
      'Skonfiguruj Tibber Pulse już teraz';
  ...
  String get watersupplierAccessRequestQ3 =>
      'Czy złożyłeś już wniosek o dostęp i otrzymałeś kod QR?';
  ...
  String get watersupplierNoAccess =>
      'Nie masz już uprawnień do pobierania danych.';
  ...
  String get counterWarmWaterPlusColdWater =>
      'Z wyłączeniem kosztów świeżej wody i ścieków';
  ...
  String get syncStatusSyncRemoteHasLatest =>
      'Plik w chmurze jest bardziej aktualny niż plik lokalny';

  @override
  String get syncObjectIsLocked =>
      'Dane obiektu są aktualizowane i w tym czasie nie można ich edytować.';
  ...
  String get importNewOrExistingCounter =>
      'Dodać do nowego lub istniejącego licznika?';
  ...
  String get supportQuestionLong =>
      'Jak to działa? Czy to w ogóle możliwe? Oto odpowiedzi.';
  ...
  String get waterExtractionMinimumLevelLower =>
      'Odliczenie ma miejsce, ponieważ zużycie jest niższe niż próg.';
  ...
  String get notificationsSmartMeterAlertFallback =>
      'Masz nowy alert inteligentnego licznika.';
  ...
  String get seasonalElectricityCounter =>
      'Sezonowy licznik energii elektrycznej';
  ...
  String get isLastEntryAtFilteredList =>
      'Najstarsza wartość na filtrowanej liście';
  ...
  String warningReadingOutdatedFrequency(
    ...
    return 'Najnowszy odczyt licznika dla $deviceTypeName $roomNamePart jest nieaktualny $outdatedSinceText.$whenNotifyDateText';
  }
  ...
  String warningNextReminderText(String date) {
    return 'Następne przypomnienie to $date.';
  }
}
